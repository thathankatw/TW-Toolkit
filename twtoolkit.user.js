...
(function (fn) {
  ...
  TWToolkit = {
    ...
    init: function () {
      ...
      TWToolkit.preferences.lang =
        TWToolkit.preferences.lang == null
          ? TWToolkit.langs[Game.locale]
            ? Game.locale
            : "en_US"
          : TWToolkit.preferences.lang;

      $.getJSON(
        TWToolkit.langs.base_url +
          TWToolkit.langs[TWToolkit.preferences.lang] +
          "?" +
          TWToolkit.version * 100,
          ...
          $.get(TWToolkit.updateURL, function (last_version) {
            if (parseFloat(last_version) > TWToolkit.version) {
              var updatedialog = new west.gui.Dialog(
                "TWToolkit",
                TWToolkit.lang.updateAvailable + " (v" + last_version + ")",
                west.gui.Dialog.SYS_WARNING
              )
                .addButton(TWToolkit.lang.updateDownload, function () {
                  updatedialog.hide();
            ...
            if (
              TWToolkit.preferences.fb_info === true ||
              TWToolkit.preferences.fb_hits === true
            )
            ...
            // if (
            //   TWToolkit.preferences.lang == "fr_FR" &&
            //   TWToolkit.preferences.vote === true
            // )
    ...
    savePreferences: function () {
      localStorage.setItem(
        ...
        JSON.stringify(TWToolkit.preferences)
      );
    },
    err: function () {
      WestUi.NotiBar.add(
    ...
    ui: {
      ...
      openWindow: function () {
        ...
        pref_content
          .append(
            new west.gui.Button(TWToolkit.lang.pref_apply)
              .click(function () {
                location.reload();
              })
              .getMainDiv()
          ...
          pref_content
            .append(
              new west.gui.Checkbox(
                TWToolkit.lang.prefs[checkboxes[i]],
                checkboxes[i]
              )
                .setId(checkboxes[i])
                .setSelected(TWToolkit.preferences[checkboxes[i]])
        ...
        pref_content.append(TWToolkit.lang.script_lang).append(
          new west.gui.Combobox()
            ...
            .select(TWToolkit.preferences.lang)
        ...
        for (var i = 0; i < inputs.length; i++) {
          grouptelegrams_content.append(
            TWToolkit.lang.prefs.grouped_telegrams[inputs[i]]
          );
          grouptelegrams_content.append(
            new west.gui.Textfield(inputs[i])
              .setValue(TWToolkit.preferences.grouped_telegrams[inputs[i]])
              .setPlaceholder("___;___;___")
              .getMainDiv()
              .on("change paste keyup", function () {
                TWToolkit.preferences.grouped_telegrams[
        ...
        grouptelegrams_content
          .append("<br/><br/>")
          .append(
            new west.gui.Button(TWToolkit.lang.create_list)
              .click(function () {
                TWToolkit.groupTelegrams.getPlayerList(function (players) {
                  $("#west-toolkit-player-nb").text(
                    players.length + " " + TWToolkit.lang.players
                  );
          ...
          .append(
            new west.gui.Button(TWToolkit.lang.send_telegram)
              .click(function () {
                TWToolkit.groupTelegrams.getPlayerList(function (players) {
          ...
          .append("<br/><br/>")
          .append(
            new west.gui.Textarea(null, null)
              .setId("west-toolkit-player-list")
              .setWidth(630)
              .setHeight(200)
              .getMainDiv()
          )
          .append('<br/><span id="west-toolkit-player-nb"></span>');
        var grouptelegrams_tab = $(
          new west.gui.Scrollpane()
            .appendContent(grouptelegrams_content)
            .addClass("west-toolkit-grouptelegrams")
            .getMainDiv()
        ).css("margin-top", "6px");
        //Best equipment tab
        var bestequip_content = $('<div style="padding:10px;"></div>');
        bestequip_content.append(
          new west.gui.Textfield("toolkit-bestequip-level")
            .setSize(3)
            .setMaxLength(3)
            .setPlaceholder(TWToolkit.lang.lvl)
            .getMainDiv()
        );
        bestequip_content.append(
          new west.gui.Button(TWToolkit.lang.bestequip_button)
            .click(function () {
        ...
        for (var name in TWToolkit.bestEquip.bonuses) {
          var bonus = $(
            '<div style="display:inline-block;"><img width="30" style="margin-left:12px" src="' +
              TWToolkit.bestEquip.bonuses[name] +
              '"/><br/></div>'
          );
          form.append(
            bonus.append(
              new west.gui.Textfield(name)
                .setName(name)
                .setPlaceholder("0.0")
                .setMaxLength(5)
                .setSize(1)
        ...
        bestequip_content.append(
          '<br/><br/><div id="west-toolkit-bestequip-res"></div>'
        );
        var bestequip_tab = $(
          new west.gui.Scrollpane()
            .appendContent(bestequip_content)
            .addClass("west-toolkit-bestequip")
            .getMainDiv()
        ).css("margin-top", "6px");
        TWToolkit.ui.window = wman
          .open("west-toolkit", null, "west-toolkit")
          .setTitle("The West Toolkit")
          .setMiniTitle("TWToolkit")
          // .addTab(
          //   TWToolkit.lang.bestequip_title,
          //   "bestequip",
          //   TWToolkit.ui.tabclick
          // )
          .addTab(
            TWToolkit.lang.grouped_telegram,
            "grouptelegrams",
            TWToolkit.ui.tabclick
          )
          .addTab(TWToolkit.lang.pref, "preferences", TWToolkit.ui.tabclick)
          .appendToContentPane(grouptelegrams_tab, pref_tab);
        TWToolkit.ui.showTab(TWToolkit.ui.window, "grouptelegrams");
      },
    },
    itemUse: {
      itemList: [
        1975000, 1976000, 2675000, 2676000, 2561000, 2562000, 13711000, 2690000,
        379000, 50382000, 50839000, 50855000, 51156000, 51324000, 2136000,
        2393000, 2137000, 2394000, 2138000, 2395000, 2139000, 2559000, 51468000,
        2560000, 51810000, 51921000, 2196000, 2197000, 2198000, 2199000,
        2200000, 21340000, 21341000, 21342000, 21343000, 50991000, 2491000,
        51066000, 51783000, 51835000, 52053000, 52293000, 51776000, 2227000,
        2345000, 50605000, 52271000,
      ],
      ...
      useEnMasse: function (itemId, number) {
        ...
        var info = $(
          ...
          .append(
            $(
              new west.gui.Button(TWToolkit.lang.stop)
                .click(function () {
        ...
        wman
          .open("progress_open", TWToolkit.lang.open_info)
      ...
      showresult: function (itemId, result, number) {
        ...
        switch (m.type) {
          ...
          case "content":
            ...
            for (var x = 0; x < result.msg.changes.length; x++) {
              var count = Bag.getItemByItemId(result.msg.changes[x].item_id)
          ...
          case "coupons":
            div = $(
              '<div><span class="tw-currency curr-bonds"></span> ' +
                m.coupons * number +
                "</div>"
            );
            break;
          case "dollar":
            div = new tw2widget.reward.DollarReward(
              m.dollar * number
            ).getMainDiv();
            break;
          case "experience":
        ...
        new west.gui.Dialog(TWToolkit.lang.open_result, div)
      ...
      init: function () {
        ...
        ItemUse.use = function (itemId, bonuses, type) {
          ...
          if (TWToolkit.itemUse.itemList.indexOf(itemId) !== -1) {
            ...
            var dialogDiv = $(
              ".system_icon_question + .tw2gui_dialog_text > div"
            );
            dialogDiv.html(
              dialogDiv.html() +
                TWToolkit.lang.open_number +
                '<p><input class="open_popup_input" type="text" id="open_popup_input" value="1" style="width:50px;" />' +
                '<span class="open_count_scrolls"><img src="images/scrollbar/scroll_up.png" id="open_rise_count" alt="' +
                "en haut" +
                '"><img src="/images/scrollbar/scroll_down.png" id="open_lower_count" alt="' +
                "en bas" +
    ...
    itemBuy: {
      ...
      buyEnMasse: function (item, count) {
        ...
        new west.gui.Dialog(
          TWToolkit.lang.buy_confirm_title,
          "<br><p>" +
            TWToolkit.lang.buy_confirm_text1 +
            format_money(price) +
            "<br>" +
            TWToolkit.lang.buy_confirm_text2 +
            count +
            " [" +
            item.obj.name +
            "] ?</p>"
          ...
          .addButton("yes", function () {
            if (price <= Character.deposit + Character.money) {
              Ajax.remoteCall(
                ...
                function (json) {
                  if (json.error) {
                    ...
                    return new UserMessage(
                      TWToolkit.lang.buy_error_location,
                      UserMessage.TYPE_ERROR
                    ).show();
                  } else {
                    ...
                    wman
                      .open("progress_buy", TWToolkit.lang.buy_info)
                      .setMiniTitle("TW Toolkit")
                      .addClass("nocloseall")
                      .addClass("noclose")
                      .addClass("noreload")
              ...
              new UserMessage(
                TWToolkit.lang.buy_error_money,
                UserMessage.TYPE_ERROR
              ).show();
            }
          })
      ...
      init: function () {
        ...
        Trader.buyDialog = function (item_id) {
          ...
          xhtml =
            ...
            TWToolkit.lang.buy_number +
            '</span><p><input class="item_popup_input" type="text" id="item_popup_input" value="1"/>' +
            '<span class="item_count_scrolls"><img src="/images/scrollbar/scroll_up.png" id="buy_rise_count" alt="' +
            "en haut" +
            '"><img src="/images/scrollbar/scroll_down.png" id="buy_lower_count" alt="' +
            "en bas" +
            '"></span>' +
            "</p><br />" +
            '<span class="item_popup_buy_value">' +
            TWToolkit.lang.buy_item_value +
            ': $<span id="buy_popup_price"></span>,&nbsp;' +
            TWToolkit.lang.buy_total_value +
            ":" +
          ...
          $("#buy_popup_price", context).text(
            parseInt(item.count.substring(1))
          );
    ...
    fbPopup: {
      ...
      getGradeImg: function (gradeId, title, cls) {
        return (
          ...
          TWToolkit.fbPopup.gradeNames[gradeId] +
          '.png" title="' +
          (title ? TWToolkit.fbPopup.gradeNames[gradeId].escapeHTML() : "") +
          '" />'
        );
      },
      getPrivLink: function (player, grade, text, preBattle) {
        return $(
          '<a style="display: block" href="javascript: void(0);">' +
            TWToolkit.fbPopup.getGradeImg(grade) +
            " " +
            text +
            "</a>"
        ).click(function () {
      ...
      getPrivileges: function (player, pp, ownPriv, preBattle) {
        ...
        if (pp < ownPriv) {
          if (pp != gv.CAPTAIN && ownPriv > gv.CAPTAIN)
            grades.append(
              TWToolkit.fbPopup.getPrivLink(
                player,
                gv.CAPTAIN,
                TWToolkit.lang.fbpopup_appoint_captain,
                preBattle
              )
            );
          if (pp != gv.SERGEANT)
            grades.append(
              TWToolkit.fbPopup.getPrivLink(
                player,
                gv.SERGEANT,
                TWToolkit.lang.fbpopup_appoint_sergeant
              )
            );
          if (pp != gv.PRIVATE)
            grades.append(
              TWToolkit.fbPopup.getPrivLink(
                player,
                gv.PRIVATE,
                TWToolkit.lang.fbpopup_appoint_private,
                preBattle
              )
            );
          if (pp != gv.RECRUIT)
            grades.append(
              TWToolkit.fbPopup.getPrivLink(
                player,
                gv.RECRUIT,
                TWToolkit.lang.fbpopup_appoint_recruit,
                preBattle
              )
            );
          if (pp != gv.RESERVIST)
            grades.append(
              TWToolkit.fbPopup.getPrivLink(
                player,
                gv.RESERVIST,
                TWToolkit.lang.fbpopup_appoint_reservist,
                preBattle
              )
            );
          if (pp != gv.TRAITOR)
            grades.append(
              TWToolkit.fbPopup.getPrivLink(
                player,
                gv.TRAITOR,
                TWToolkit.lang.fbpopup_appoint_traitor,
                preBattle
              )
            );
        } else {
          ...
          return function (x, y, cellIdx) {
            ...
            if (popup.idx != cellIdx) {
              popup.text =
                ...
                (sector.classBonus
                  ? "<td><img src='" +
                    TWToolkit.fbPopup.getCharClassImg(sector.classType) +
                    "' /></td><td>&nbsp;" +
                    sector.classBonus +
                    "&nbsp;"
                  : "") +
            ...
            for (i = 0; i < charsatcursor.length; i++) {
              ...
              popup.text +=
                ...
                "_small_chat.png'/>&nbsp;" +
                TWToolkit.fbPopup.getGradeImg(charsatcursor[i].privilege) +
                "</td>";
                ...
                document.onkeyup = function (e) {
                  if (popup.active === true) {
                    if (e.keyCode >= 49 && e.keyCode <= 57) {
                      id = e.keyCode - 49;
                      if (charsatcursor[id]) {
                        TWToolkit.fbPopup.getPrivileges(
                          charsatcursor[id],
                          FortBattleWindow.pre.getPrivilege(charsatcursor[id]),
                          TWToolkit.fbPopup.ownGrade,
    ...
    critHits: {
      init: function () {
        ...
        var inject1 = TWToolkit.prepareInjection(
          ...
          [0],
          [
            "CemeteryWindow.table.addColumn('battle_cri',{sortBy:'crithits'}).addColumn('battle_gho',{sortBy:'playdeadcount'}).appendToThCell('head','battle_cri',TWToolkit.lang.fbcemetery_head_cri,'&nbsp;').appendToThCell('head','battle_gho',TWToolkit.lang.fbcemetery_head_gho,'&nbsp;');sortByObj.sortBy=null;",
          ]
        );
    ...
    groupTelegrams: {
      getPlayerList: function (callback) {
        var alliances =
          TWToolkit.preferences.grouped_telegrams.allys.split(";");
        var towns = TWToolkit.preferences.grouped_telegrams.towns.split(";");
        var extra_players =
          TWToolkit.preferences.grouped_telegrams.extra_players.split(";");
        var excluded_players =
          TWToolkit.preferences.grouped_telegrams.remove_players.split(";");
        var player_list = [];
        Ajax.remoteCallMode(
          "ranking",
          "get_data",
      ...
      initFbInfo: function () {
        ...
        FortBattle.getCharDataSheet = function (data) {
          return (
            ...
            '<div><img src="' +
            TWToolkit.icons.totaldmg +
            '" title="' +
            TWToolkit.lang.fbinfo_totaldmg +
            '" /> %totalDmg%</div>'
          );
        };
      },
        ...
        FortBattle.addRoundStatusMessage = function (fortId, queue) {
          ...
          if (queue.length !== 0) {
            FortBattle.showMessage(
              fortId,
              "<strong>" +
                TWToolkit.lang.fbinfo_total +
                " | " +
                TWToolkit.lang.fbinfo_hit +
                " : </strong>" +
                TWToolkit.FortBattleInfo.stats[fortId].hit +
                "<strong> | " +
                TWToolkit.lang.fbinfo_missed +
                " : </strong>" +
                TWToolkit.FortBattleInfo.stats[fortId].missed +
                "<strong> | " +
                TWToolkit.lang.fbinfo_gotshot +
                " : </strong>" +
                TWToolkit.FortBattleInfo.stats[fortId].gotshot +
                "<strong> | " +
                TWToolkit.lang.fbinfo_dodge +
                " : </strong>" +
                TWToolkit.FortBattleInfo.stats[fortId].dodge
            );
          }
    ...
    reminders: {
      ...
      initVote: function () {
        if (
          !TWToolkit.preferences.vote_time ||
          (new Date(Game.getServerTime() * 1000) >
            new Date(TWToolkit.preferences.vote_time * 1000) &&
            new Date(Game.getServerTime() * 1000).getDay() !==
              new Date(TWToolkit.preferences.vote_time * 1000).getDay())
        ) {
          TWToolkit.reminders.add(
            "vote",
            TWToolkit.lang.prefs.vote,
            TWToolkit.icons.vote_reminder,
            function () {
      ...
      initAdvent: function () {
        if (
          new Date(Game.getServerTime() * 1000).getMonth() == 11 &&
          new Date(Game.getServerTime() * 1000).getDate() <= 25 &&
          Bag.getItemByItemId(12700000)
        ) {
          if (
            !TWToolkit.preferences.calendar_time ||
            (new Date(Game.getServerTime() * 1000) >
              new Date(TWToolkit.preferences.calendar_time * 1000) &&
              new Date(Game.getServerTime() * 1000).getDay() !==
                new Date(TWToolkit.preferences.calendar_time * 1000).getDay())
          ) {
            TWToolkit.reminders.add(
              "calendar",
              TWToolkit.lang.calendar,
              TWToolkit.icons.advent_calendar,
              function () {
    ...
    bestEquip: {
      ...
      getBestEquipment: function () {
        var filter = TWToolkit.bestEquip.jsonifyForm(
          $("form#west-toolkit-filter")
        );
        $.get(
          "https://www.west-tools.info/toolkit/calc.php",
          {
          ...
          function (json) {
            if (json.err) {
              ...
              for (var i = 0; i < json.items.length; i++) {
                $("div#west-toolkit-bestequip-res").append(
                  new tw2widget.InventoryItem(
                    ItemManager.get(json.items[i]),
                    "item_popup_item"
                  ).getMainDiv()
                );
              }
    ...
    fbanalyzerHtml5: {
      ...
      open: function (fortId) {
        ...
        tab_search.append(
          new west.gui.Textfield("analyzer-search")
            .setPlaceholder(TWToolkit.lang.search)
            .getMainDiv()
            .on("change paste keyup", function () {
              var input = $(this).find("input").val();
              var results = TWToolkit.fbanalyzerHtml5.searchPlayers(
                fortId,
                input
              );
        ...
        var search_results = new west.gui.Table()
          ...
          .createEmptyMessage(TWToolkit.lang.no_results);
        ...
        TWToolkit.fbanalyzerHtml5.fbs[fortId].window = wman
          .open(
          ...
          .setMiniTitle("TWToolkit")
          .addTab(TWToolkit.lang.stats, "stats", TWToolkit.ui.tabclick)
          .addTab(TWToolkit.lang.search, "search", TWToolkit.ui.tabclick)
          .addTab(TWToolkit.lang.graph, "graph", TWToolkit.ui.tabclick)
          .appendToContentPane(tab_stats, tab_search, tab_graph)
          .setSize(600, 410);
        var ctx = $(TWToolkit.fbanalyzerHtml5.fbs[fortId].window.divMain)
          .find("canvas#graph")
          .get(0)
          .getContext("2d");
        TWToolkit.fbanalyzerHtml5.fbs[fortId].graph.chart = new Chart(
          ctx,
          TWToolkit.fbanalyzerHtml5.fbs[fortId].graph.config
        );
        TWToolkit.ui.showTab(
          TWToolkit.fbanalyzerHtml5.fbs[fortId].window,
          "stats"
        );
      ...
      addButton: function (fortId, windowDiv) {
        $(windowDiv)
          ...
          .append(
            '<div class="fort_battle_button_analyzer" onclick="TWToolkit.fbanalyzerHtml5.open(' +
              fortId +
              ')" title="' +
              TWToolkit.lang.openanalyzer +
              '" style="cursor: pointer; position: absolute; background-image: url(' +
              TWToolkit.icons.analyzer_button +
      ...
      searchPlayers: function (fortId, input) {
        ...
        if (search === "") {
          ...
          for (var charId in players) {
            var dist = TWToolkit.fbanalyzerHtml5.dameraulevenshtein_dist(
              search,
      ...
      showSearchResults: function (fortId, players) {
        var search_results =
          TWToolkit.fbanalyzerHtml5.fbs[fortId].search_results;
        ...
        if (players.length > 0) {
          ...
          for (var i = 0; i < players.length; i++) {
            ...
            search_results.appendToCell(
              i,
              "player",
              TWToolkit.fbanalyzerHtml5.getPlayerHTML(fortId, players[i].charId)
            );
          }
        } else {
          search_results.$("div.no-content").show();
      ...
      updateStats: function (fortId) {
        if (
          ...
          var container = $(
            TWToolkit.fbanalyzerHtml5.fbs[fortId].window.divMain
          ).find("#stats");
          ...
          function getClasses(team) {
            var html = "";
            var classes =
              TWToolkit.fbanalyzerHtml5.fbs[fortId].data[team].classes;
            for (var cl in classes) {
              html +=
                `<figure style="display:inline-block;cursor:pointer;margin-left:2px;margin-right:2px;" onmouseenter="TWToolkit.fbanalyzerHtml5.showClass(` +
                fortId +
                `,'` +
                team +
                `','` +
                cl +
                `')" onmouseleave="TWToolkit.fbanalyzerHtml5.hidePosition(` +
                fortId +
                ');">' +
          ...
          table
            ...
            .appendToCell("head", "losthp", TWToolkit.lang.losthp)
            .appendToCell("head", "dmg", TWToolkit.lang.fbinfo_lastdmg);
          ...
          for (var i = 0; i < hp.length; i++) {
            ...
            table
              ...
              .appendToCell(
                i,
                "hp",
                TWToolkit.fbanalyzerHtml5.getPlayerHTML(fortId, hp[i])
              )
              .appendToCell(
                i,
                "losthp-val",
              ...
              .appendToCell(
                ...
                (data.players[losthp[i]].health <= 0
                  ...
                  ? '<div class="mini_system_icon_warning" title="' +
                    TWToolkit.lang.hpwarning +
                    '"></div>'
                  : "") +
                  TWToolkit.fbanalyzerHtml5.getPlayerHTML(fortId, losthp[i])
              )
              .appendToCell(
                i,
                "dmg-val",
              ...
              .appendToCell(
                i,
                "dmg",
                TWToolkit.fbanalyzerHtml5.getPlayerHTML(fortId, dmg[i])
              );
          }
          container.html(
            new west.gui.Scrollpane()
      ...
      updateGraph: function (fortId) {
        if (
          ...
          var data = TWToolkit.fbanalyzerHtml5.fbs[fortId].data;
          TWToolkit.fbanalyzerHtml5.fbs[fortId].graph.config.data.labels.push(
            data.round
          );
          TWToolkit.fbanalyzerHtml5.fbs[
            fortId
      ...
      getPlayerHTML: function (fortId, charId) {
        ...
        return (
          ...
          ';font-weight:bold;cursor: pointer;" onmouseleave="TWToolkit.fbanalyzerHtml5.hidePosition(' +
          fortId +
          ')" onmouseenter="TWToolkit.fbanalyzerHtml5.showPosition(' +
          fortId +
          "," +
          charId +
          ...
          if (info.characters) {
            for (var i = 0; i < info.characters.length; i++) {
              ...
              if (player.health > 0) {
                ...
                TWToolkit.fbanalyzerHtml5.fbs[fortId].data[team_name].hp +=
                  player.health;
                if (
                  !TWToolkit.fbanalyzerHtml5.fbs[fortId].data[team_name]
                    .classes[player.class]
                ) {
                  TWToolkit.fbanalyzerHtml5.fbs[fortId].data[team_name].classes[
                    player.class
                  ] = 0;
                }
                TWToolkit.fbanalyzerHtml5.fbs[fortId].data[team_name].classes[
              ...
              TWToolkit.fbanalyzerHtml5.fbs[fortId].data.players[char_id] =
                player;
      ...
      handleRoundInfo: function (fortId, updatedChar, roundInfo) {
        if (
          TWToolkit.fbanalyzerHtml5.fbs[fortId] &&
          TWToolkit.fbanalyzerHtml5.fbs[fortId].data
        ) {
          var data = TWToolkit.fbanalyzerHtml5.fbs[fortId].data;
          TWToolkit.fbanalyzerHtml5.fbs[fortId].data.round =
          ...
          for (var charId in updatedChar) {
            var player =
              TWToolkit.fbanalyzerHtml5.fbs[fortId].data.players[charId];
      ...
      init: function () {
        ...
        FortBattleWindow.handleRoundInfoSignal = function (roundInfo) {
          ...
          TWToolkit.fbanalyzerHtml5.handleRoundInfo(
            this.fortId,
    ...
    owned_forts: {
      init: function () {
        $(document).on("click", ".tow_profileheader img", function () {
          ...
          if (
            TWToolkit.owned_forts.data[town_id] &&
            TWToolkit.owned_forts.data[town_id][prop].length !== 0
          ) {
            ...
            for (var j in json.forts[i]) {
              ...
              if (fort.fort) {
                ...
                for (var k = 0; k < members.length; k++) {
                  ...
                  TWToolkit.owned_forts.data[members[k]].members.push(
                    fort_data
                  );
                }
              }
      ...
      open: function (townId, type) {
        ...
        table
          .addColumn("fortname")
          .addColumn("fortsize")
          .appendToCell("head", "fortname", TWToolkit.lang.forts)
          .appendToCell("head", "fortsize", TWToolkit.lang.fort_size);
        ...
        for (var i = 0; i < forts.length; i++) {
          ...
          table
            ...
            .appendToCell(
              i,
              "fortsize",
              TWToolkit.lang.fort_sizes[forts[i].type]
            );
        }
        ...
        wman
          ...
          .setTitle(TWToolkit.lang.forts)
          .setMiniTitle(TWToolkit.lang.forts)
